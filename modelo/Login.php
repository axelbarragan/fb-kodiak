...
public function login($usuario, $pass) {
  ...
  $query = "SELECT * FROM sesion INNER JOIN usuarios ON sesion.id_usuario = usuarios.id_usuario INNER JOIN t_salt ON sesion.id_usuario = t_salt.id_usuario WHERE sesion.correo_usuario = '".$this->user."'";
